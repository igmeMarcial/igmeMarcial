...
## Key Skills
- **AI/ML**: Model training, fine-tuning, and experimentation (no production deployments yet)
- **Collaboration**: Working effectively in cross-functional teams and learning from senior engineers
